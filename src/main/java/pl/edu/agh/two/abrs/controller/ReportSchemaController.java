...
public class ReportSchemaController {
	...
	public @ResponseBody String createReport(@RequestBody final ReportSchema reportSchema) {
		reportSchemaService.add(reportSchema);
		return "OK";
	}

	@RequestMapping(value = "/remove/{id}", method = RequestMethod.POST)
	public @ResponseBody String removeReport(@PathVariable("id") Long id) {
	...
	public @ResponseBody String editReport(@RequestBody ReportSchema reportSchema) {
